...
local function installBlock(buildRF, blockType, blockId, worldCFrame, timeout)
	...
	connection = BlocksFolder.ChildAdded:Connect(function(child)
		if not created and child.Name == blockType then
			created = child
		end
	end)
	...
	while not created and os.clock() < deadline do
...
Title.Text = "BABFT Bad Apple Builder V0.3"
...
Info.Text = "64×64 / 3FPS / 250프레임\nDisplay 4096개 · Delay 500개 수직 적층"
